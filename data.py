...
def select_race(racename,race_number):
    ...
    if racename == "Barber Motorsports Park":
        if racename == "Race 1":
            ...
            file_results_official_class = load_data('data/Race 1/05_Results by Class GR Cup Race 1 Official_Anonymized.CSV')
            file_analysis = load_data('data/Race 1/23_AnalysisEnduranceWithSections_Race 1_Anonymized.CSV')
            file_weather = load_data('data/Race 1/26_Weather_Race 1_Anonymized.CSV')
            file_best10 = load_data('data/Race 1/99_Best 10 Laps By Driver_Race 1_Anonymized.CSV')
            file_lap_end = load_data('data/Race 1/R1_barber_lap_end.csv')
            file_lap_start = load_data('data/Race 1/R1_barber_lap_start.csv')
            final_lap_ms = load_data('data/Race 1/R1_barber_lap_time.csv')
        else:
            file_result_provisional = load_data('data/Race 2/03_Provisional Results_Race 2_Anonymized.CSV')
            file_results_official = load_data('data/Race 2/03_Results GR Cup Race 2 Official_Anonymized.CSV')
            file_result_provisional_class = load_data('data/Race 2/05_Provisional Results by Class_Race 2_Anonymized.CSV')
            file_analysis = load_data('data/Race 2/23_AnalysisEnduranceWithSections_Race 2_Anonymized.CSV')
            file_weather = load_data('data/Race 2/26_Weather_Race 2_Anonymized.CSV')
            file_best10 = load_data('data/Race 2/99_Best 10 Laps By Driver_Race 2_Anonymized.CSV')
            file_lap_end = load_data('data/Race 2/R2_barber_lap_end.csv')
        ...
        if race_number == "Race 1":
            ...
            file_weather = load_data('data/Race 1/26_Weather_Race 1_Anonymized.CSV')
            file_best10 = load_data('data/Race 1/99_Best 10 Laps By Driver_Race 1_Anonymized.CSV')
            file_lap_end = load_data('data/Race 1/COTA_lap_end_time_R1.csv')
            file_lap_start = load_data('data/Race 1/COTA_lap_start_time_R1.csv')
            final_lap_ms = load_data('data/Race 1/COTA_lap_time_R1.csv')
        else:
            file_result_provisional = load_data('data/Race 2/03_Provisional Results_ Race 2_Anonymized.CSV')
            file_result_provisional_class = load_data('data/Race 2/05_Provisional Results by Class_ Race 2_Anonymized.CSV')
            file_analysis = load_data('data/Race 2/23_AnalysisEnduranceWithSections_ Race 2_Anonymized.CSV')
            file_weather = load_data('data/Race 2/26_Weather_ Race 2_Anonymized.CSV')
            file_best10 = load_data('data/Race 2/99_Best 10 Laps By Driver_ Race 2_Anonymized.CSV')
        ...
        if race_number == "Race 1":
            ...
            file_weather = load_data('data/Race 1/26_Weather_Race 1_Anonymized.CSV')
            file_best10 = load_data('data/Race 1/99_Best 10 Laps By Driver_Race 1_Anonymized.CSV')
            file_lap_end = load_data('data/Race 1/road_america_lap_end_R1.csv')
            file_lap_start = load_data('data/Race 1/road_america_lap_start_R1.csv')
            final_lap_ms = load_data('data/Race 1/road_america_lap_time_R1.csv')
        else: 
            file_result_provisional = load_data('data/Race 2/03_Provisional Results_Race 2_Anonymized.CSV')
            file_results_official = load_data('data/Race 2/03_Results GR Cup Race 2 Official_Anonymized.CSV')
            file_result_provisional_class = load_data('data/Race 2/05_Provisional Results by Class_Race 2_Anonymized.CSV')
            ...
            file_weather = load_data('data/Race 2/26_Weather_Race 2_Anonymized.CSV')
            file_best10 = load_data('data/Race 2/99_Best 10 Laps By Driver_Race 2_Anonymized.CSV')
            file_lap_end = load_data('data/Race 2/road_america_lap_end_R2.csv')
            file_lap_start = load_data('data/Race 2/road_america_lap_start_R2.csv')
            final_lap_ms = load_data('data/Race 2/road_america_lap_time_R2.csv')
        ...
        if race_number == "Race 1":
            ...
            file_weather = load_data('data/Race 1/26_Weather_Race 1_Anonymized.CSV')
            file_best10 = load_data('data/Race 1/99_Best 10 Laps By Driver_Race 1_Anonymized.CSV')
            file_lap_end = load_data('data/Race 1/sebring_lap_end_time_R1.csv')
            file_lap_start = load_data('data/Race 1/sebring_lap_start_time_R1.csv')
            final_lap_ms = load_data('data/Race 1/sebring_lap_time_R1.csv')
        else:  
            file_results_official = load_data('data/Race 2/00_Results GR Race 2 Official_Anonymized.CSV')
            file_result_provisional = load_data('data/Race 2/03_Provisional Results_Race 2_Anonymized.CSV')
            file_result_provisional_class = load_data('data/Race 2/05_Provisional Results by Class_Race 2_Anonymized.CSV')
            file_analysis = load_data('data/Race 2/23_AnalysisEnduranceWithSections_Race 2_Anonymized.CSV')
            file_weather = load_data('data/Race 2/26_Weather_Race 2_Anonymized.CSV')
            file_best10 = load_data('data/Race 2/99_Best 10 Laps By Driver_Race 2_Anonymized.CSV')
            file_lap_end = load_data('data/Race 2/sebring_lap_end_time_R2.csv')
            file_lap_start = load_data('data/Race 2/sebring_lap_start_time_R2.csv')
            final_lap_ms = load_data('data/Race 2/sebring_lap_time_R2.csv')          
    elif racename == "Sonoma":
        if race_number == "Race 1":
            file_results_official = load_data('data/Race 1/03_Results_Anonymized.CSV')
            file_results_official_class = load_data('data/Race 1/05_Results by Class_Race 1_Anonymized.CSV')
            file_analysis = load_data('data/Race 1/23_AnalysisEnduranceWithSections_Race 1_Anonymized.CSV')
            file_weather = load_data('data/Race 1/26_Weather_Race 1_Anonymized.CSV')
            file_best10 = load_data('data/Race 1/99_Best 10 Laps By Driver_Race 1_Anonymized.CSV')
            file_lap_end = load_data('data/Race 1/sonoma_lap_end_time_R1.csv')
            file_lap_start = load_data('data/Race 1/sonoma_lap_start_time_R1.csv')
            final_lap_ms = load_data('data/Race 1/sonoma_lap_time_R1.csv')
        else:
            file_result_provisional = load_data('data/Race 2/03_Provisional_Results_Race 2_Anonymized.CSV')
            file_results_official = load_data('data/Race 2/03_Results_Anonymized.CSV')
            file_result_provisional_class = load_data('data/Race 2/05_Provisional_Results by Class_Race 2_Anonymized.CSV')
            file_analysis = load_data('data/Race 2/23_AnalysisEnduranceWithSections_Race 2_Anonymized.CSV')
            file_best10 = load_data('data/Race 2/99_Best 10 Laps By Driver_Race 2_Anonymized.CSV')
        ...
        if race_number == "Race 1":
            ...
            file_weather = load_data('data/Race 1/26_Weather_Race 1_Anonymized.CSV')
            file_best10 = load_data('data/Race 1/99_Best 10 Laps By Driver_Race 1_Anonymized.CSV')
            file_lap_end = load_data('data/Race 1/vir_lap_end_R1.csv')
            file_lap_start = load_data('data/Race 1/vir_lap_start_R1.csv')
            final_lap_ms = load_data('data/Race 1/vir_lap_time_R1.csv')
        else:
            file_result_provisional = load_data('data/Race 2/03_Provisional Results_Race 2_Anonymized.CSV')
            file_results_official = load_data('data/Race 2/03_Results GR Cup Race 2 Official_Anonymized.CSV')
            file_result_provisional_class = load_data('data/Race 2/05_Provisional Results by Class_Race 2_Anonymized.CSV')
            ...
            file_weather = load_data('data/Race 2/26_Weather_Race 2_Anonymized.CSV')
            file_best10 = load_data('data/Race 2/99_Best 10 Laps By Driver_Race 2_Anonymized.CSV')
            file_lap_end = load_data('data/Race 2/vir_lap_end_R2.csv')
